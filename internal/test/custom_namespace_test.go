...
var _ = Describe("Creating Kubegres with a custom namespace", func() {
	...
	BeforeEach(func() {
		...
		test.dbQueryTestCases = testcases.InitDbQueryTestCasesWithNodePorts(test.resourceCreator, resourceConfigs2.KubegresResourceName, resourceConfigs2.ServiceToSqlQueryPrimaryDbNodePort+4, resourceConfigs2.ServiceToSqlQueryReplicaDbNodePort+4)
	})
